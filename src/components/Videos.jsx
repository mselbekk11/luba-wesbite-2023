  ...
  return (
    <div className="videos">
      ...
      <div className="container">
        ...
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/JVDcujO2foo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  )
